...
export default function Home() {
  ...
  return (
    <main className="min-h-screen font-mono bg-cyber-black text-neon-blue">
      ...
      {/* Hackathon MVP Recap */}
      <section id="mvp-recap" className="py-12 md:py-16 bg-cyber-black border-y border-neon-pink/30">
        <div className="px-4 mx-auto max-w-6xl">
          <h3 className="mb-4 text-2xl font-bold md:mb-6 md:text-3xl text-neon-blue">SYSTEM::MVP_RECAP</h3>
      ...
      <section id="get-started" className="py-12 text-center backdrop-blur-sm md:py-16 bg-neon-purple/10">
        <div className="px-4 mx-auto max-w-6xl">
          <h4 className="mb-3 text-xl font-bold md:mb-4 md:text-2xl text-neon-pink">READY_TO_HACK?</h4>
